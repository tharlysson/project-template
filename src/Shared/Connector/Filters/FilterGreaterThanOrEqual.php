...
final class FilterGreaterThanOrEqual extends AbstractFilterSearchValue
{
    public function __construct(
        ...
        parent::__construct(Filter::OPERATOR_GREATER_THAN_OR_EQUAL, $this->$attribute, $this->value);
    }
}
